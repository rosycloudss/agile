...
<body>
    ...
    <form action="<%=request.getContextPath() %>/background/manage/adddish.action" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
    ...
    <li><label>图片信息</label><cite><input type="file" name="img"/></cite></li>
