    ...
    <div style="width: 70%;margin-left: auto;margin-right: auto;">
        <ul class=" newpd-list clearfix">
            <li class="layui-col-md6" style="height: 686.875px;">
                <div class="widget">
                    <figure class="widget-header">
                        <a href="https://mb.mituo.cn/mui144/product/product.php?class2=11" title="西式菜系" target="_self">
                    ...
                    <h4 class="widget-title" data-plugin="appear"
                        data-animate="slide-bottom50" data-repeat="false" color="#212121" tr="0.7" trh="0.75"
                        style="background: rgba(33, 33, 33, 0.7);">
                        <a href="https://mb.mituo.cn/mui144/product/product.php?class2=11" title="西式菜系" target="_self">
                            <h3>西式菜系</h3>
            ...
            <li class="layui-col-md6 " style="height: 343.438px;">
                <div class="widget">
                    <figure class="widget-header">
                        <a href="https://mb.mituo.cn/mui144/product/product.php?class2=12" title="中式菜系" target="_self">
                            <div class="cover-image layui-anim" data-anim="layui-anim-scaleSpring"
                    ...
                    <h4 class="widget-title" data-plugin="appear"
                        data-animate="slide-right50" data-repeat="false" color="#212121" tr="0.7" trh="0.75"
                        style="background: rgba(33, 33, 33, 0.7);">
                        <a href="https://mb.mituo.cn/mui144/product/product.php?class2=12" title="中式菜系" target="_self">
                            <h3 style="color: #c8c8c8; ">中式菜系</h3>
                            <p class="desc">中国八大菜系菜品选料考究、 技法多样、 制作精良的烹饪技艺闻名于世。 基于此， 《中国八大菜系及中式...</p>
                        </a>
                    </h4>
                </div>
            </li>
            <li class="layui-col-md6 " style="height: 343.438px;">
                <div class="widget">
                    <figure class="widget-header">
                        <a href="https://mb.mituo.cn/mui144/product/product.php?class2=13" title="面类点心" target="_self">
                            <div class="cover-image"
            ...
            <li class="layui-col-md12 " style="height: 343.438px;">
                <div class="widget">
                    <figure class="widget-header">
                        <a href="https://mb.mituo.cn/mui144/product/product.php?class2=14" title="蔬菜类菜肴" target="_self">
                            <div class="cover-image"
