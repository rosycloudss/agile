...
<%-- <script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-3.4.1.js"></script> --%>
	<style> 
		...
		.div1{ margin-left:350px; width:400px; height:100px; border:1px } 
		.div2{ margin-left:850px; width:300px; height:100px; border:1px }
	</style> 
...
<body>
	...
	<div class="div1" id="o-box-down"  style="table-layout:fixed;">
	    ...
	    <div class="layui-form-item layui-form-text" style="margon-left:350px">
	        <input type="button" name="addAddress" onclick="open ()" maxlength="100" id="addAddress" class="i-text" style="height:25px;
